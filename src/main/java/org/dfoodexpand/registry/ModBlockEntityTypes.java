...
import org.dfoodexpand.block.entity.*;
...
public class ModBlockEntityTypes {
    ...
    public static final BlockEntityType<HookBlockEntity> HOOK = register("hook", BlockEntityType.Builder.create(
            HookBlockEntity::new, ModBlocks.HOOK));
